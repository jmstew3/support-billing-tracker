...
def process_csv(input_file, output_file):
    """Reads a CSV, cleans the 'message_text' column, and writes to a new CSV."""
    try:
...
if __name__ == "__main__":
    # The script will use the updated file paths
    input_csv_path = "/Users/justinstewart/thad-chat/data/01_raw/thad_norman_messages_complete.csv"
    output_csv_path = "/Users/justinstewart/thad-chat/data/02_processed/thad_norman_messages_cleaned.csv"
