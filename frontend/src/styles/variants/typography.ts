  ...
  'transition-colors duration-200',
  {
    variants: {
      variant: {
        ...
        // Component-specific
        scorecardValue: 'text-xl sm:text-2xl font-bold',
        scorecardTitle: 'text-xs sm:text-sm font-medium',
        scorecardDescription: 'text-xs font-normal',
        tableHeader: 'text-xs sm:text-sm font-semibold',
        tableCell: 'text-xs sm:text-sm font-normal',
      },
      color: {
