    ...
    >
      ...
      <div className="px-6 pb-6 space-y-4" style={{ paddingBottom: `max(1.5rem, env(safe-area-inset-bottom))` }}>
        ...
        <div className="flex items-center justify-center gap-6">
          ...
          <button
            onClick={onLogout}
            className="flex items-center gap-2 px-4 py-2 text-sm text-destructive hover:text-destructive/80 transition-colors min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
            <LogOut size={18} />
            <span>Log Out</span>
          </button>
