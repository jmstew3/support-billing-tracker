...
describe('SupportTableSection', () => {
  ...
  const defaultProps = {
    ...
    categoryFilter: [],
    urgencyFilter: [],
    billingDateFilter: { from: null, to: null, hasValue: 'all' as const },
    hoursFilter: [],
    ...
    onBillingDateFilterChange: vi.fn(),
    onHoursFilterChange: vi.fn(),
    ...
    filterCounts: {
      ...
      day: { Mon: 1, Tue: 1 },
      hours: { '0-0.5': 1, '0.5-1': 1 },
      billingDate: { hasValue: 0, noValue: 2 }
    },
    activeFilterCount: 0,
